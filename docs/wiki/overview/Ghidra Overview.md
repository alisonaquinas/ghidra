---
title: "Ghidra Overview"
aliases: ["Ghidra Overview"]
category: overview
tags: [ghidra, reverse-engineering, nsa, overview]
status: stub
sources: []
updated: 2026-05-06
---
...
- Headless/batch mode
- Multi-user collaboration via GhidraServer
- Behavioral similarity search (BSim)
- Dynamic debugging integration
...
- Exact version history and open-source release date?
- What changed in the 12.x release line?
