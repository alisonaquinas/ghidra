...
Created directory layout, AGENTS.md schema, index.md catalog, and stub pages for all planned categories.
No raw sources ingested yet. All pages are `status: stub`.
