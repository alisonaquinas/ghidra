...
The Ghidra Scripting API is the public interface exposed to Java and Python scripts for programmatic access to the
Program model and Ghidra services.
